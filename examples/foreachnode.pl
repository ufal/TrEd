...
#
#  $node         - current node
#  $NodeIndex    - index of the current node (i.e. its ord)
...
#  $err2         - $node's err2 original value (by default it is deleted before
#                  evaluating SCRIPT).
#
# If you want to save the file after each node is processed, set the $save var. to 1
#
#
