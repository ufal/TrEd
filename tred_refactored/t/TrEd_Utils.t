...
sub test_read_stylesheets_new {
  SKIP: {
    ...
    # 18 tests
    _subtest_read_stylesheet_new(\&TrEd::Utils::read_stylesheets_new, $fn_name, $stylesheet_dir, $file_name, $file_name_2);
...
sub test_read_stylesheets_old {
  SKIP: {
    ...
    # 18 tests
    _subtest_read_stylesheet_old(\&TrEd::Utils::read_stylesheets_old, $fn_name, $file_name, $stylesheet_name_1, $stylesheet_name_2);
...
sub test_read_stylesheets {
  ...
  SKIP: {
    ...
    # 18 tests
    _subtest_read_stylesheet_new(\&TrEd::Utils::read_stylesheets, $fn_name, $stylesheet_dir, $file_name, $file_name_2);
  ...
  SKIP: {
    ...
    # 18 tests
    _subtest_read_stylesheet_old(\&TrEd::Utils::read_stylesheets, $fn_name, $file_name, $stylesheet_name_1, $stylesheet_name_2);
...
sub test_save_stylesheet_file {
  ...
  save_stylesheet_file(\%gui, $dir_name, $stylesheet_1);
