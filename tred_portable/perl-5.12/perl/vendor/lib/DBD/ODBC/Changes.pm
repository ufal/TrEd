...
(As of $LastChangedDate: 2010-09-22 08:40:40 +0100 (Wed, 22 Sep 2010) $ $Revision: 10667 $)
...
=head1 Todo
 ...
 Write a test for XML type columns in SQL Server
...
to return the wrong result - see
http://www.perlmonks.org/?node_id=860211 and a big thank you to Perl
Monks and in particular ikegami.

Changed bind_col so it actually pays attention to the TYPE attribute
as you could not override the bind type of a bound column before.
...
a read-only attribute and is used during array binding of parameters.
